...
public class PlayerManager : MonoBehaviour
{
    ...
    /// <summary>
    /// 조준 시작 시 한 번만 필요한 카메라, UI, 이동, 리그, 애니메이션 상태를 적용합니다.
    /// </summary>
    ...
    /// <summary>
    /// 조준 중 매 프레임 필요한 조준 위치, 회전, 사격 입력만 처리합니다.
    /// </summary>
    ...
    /// <summary>
    /// 조준 종료 시 한 번만 필요한 카메라, UI, 리그, 애니메이션 상태를 해제합니다.
    /// </summary>
    private void EndAim()
    {
        if (!m_isAiming)
    ...
    /// <summary>
    /// 조준 시작/종료 전환에서 한 번만 적용할 카메라, UI, 이동, 리그, 애니메이션 상태를 모읍니다.
    /// </summary>
    /// <param name="isAiming">전환 후 조준 상태입니다.</param>
